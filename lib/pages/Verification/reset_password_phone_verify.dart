import 'package:bazar_books_mobile_app_cloning/pages/ForgotPassword/new_password_page.dart';
...
class ResetPasswordPhoneVerifyPage extends StatefulWidget {
  const ResetPasswordPhoneVerifyPage({super.key});

  @override
  State<StatefulWidget> createState() => ResetPasswordPhoneVerifyPageState();
}

class ResetPasswordPhoneVerifyPageState
    extends State<ResetPasswordPhoneVerifyPage> {
              ...
              IconButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ResetPasswordWithPhonePage()));
                },
                icon: FaIcon(
