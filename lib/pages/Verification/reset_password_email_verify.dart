...
class ResetPasswordEmailVerifyPage extends StatefulWidget {
  const ResetPasswordEmailVerifyPage({super.key});

  @override
  State<StatefulWidget> createState() => ResetPasswordEmailVerifyPageState();
}

class ResetPasswordEmailVerifyPageState
    extends State<ResetPasswordEmailVerifyPage> {
              ...
              IconButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ResetPasswordWithEmailPage()));
                },
                icon: FaIcon(
